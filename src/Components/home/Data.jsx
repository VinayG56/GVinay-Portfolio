  ...
  return (
    <>
      <div className="home_data">
        ...
        <h3 className="home_subtitle">Full Stack Web Developer / Competitive Coder / <br />Web Designer / </h3>
        </div>
        <p className="home_description">I'm a creative Web Developer focused on user-friendly projects. I am passionate about building excellent software that improves the lives of those around me.</p>
        <a href="#contact" className="button button_flex">Say Hello 
        <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
